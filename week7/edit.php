...
$res=mysqli_query($link,"select * from week7 where id=$id");
...
if(isset($_POST["update"]))
    {
        mysqli_query($link,"update week7 set firstname='$_POST[firstname]',lastname='$_POST[lastname]',email='$_POST[email]',contact='$_POST[contact]' where id=$id");
